    ...
    <section id="location" className="py-24 bg-white scroll-mt-20">
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-stretch">
          {/* KARTU ALAMAT - ID contact sudah dihapus agar tidak tumpang tindih */}
          <div className="lg:w-[40%] flex flex-col">
            <div className="h-full p-8 md:p-10 bg-slate-50 rounded-[2.5rem] border-l-8 border-amber-500 shadow-sm flex flex-col justify-center">
              <div className="mb-6">
          ...
          {/* MAPS - URL Iframe disederhanakan */}
